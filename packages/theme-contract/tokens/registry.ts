...
export const TOKEN_REGISTRY = {
  ...
  '--collections-root-padding-top': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-root-padding-x-sm': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-root-padding-bottom-sm': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-root-padding-top-sm': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-root-padding-x-md': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-root-padding-bottom-md': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-root-padding-top-md': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-root-padding-x-lg': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-root-padding-bottom-lg': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-root-padding-top-lg': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-root-padding-x-xl': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-root-padding-bottom-xl': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-root-padding-top-xl': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-root-padding-x-2xl': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-container-max-width': { category: 'size', unit: 'px', scope: 'theme' },
  '--collections-container-width': { category: 'size', scope: 'theme' },
  '--collections-container-gap': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-container-gap-md': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-grid-gap': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-grid-gap-sm': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-grid-gap-md': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--collections-grid-gap-lg': { category: 'spacing', unit: 'px', scope: 'theme' },
  // ── v2 миграция — токены блока (добавлено скриптом)
  '--popular-products-root-padding-x': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-root-padding-bottom': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-root-padding-top': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-root-padding-x-sm': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-root-padding-bottom-sm': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-root-padding-top-sm': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-root-padding-x-md': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-root-padding-bottom-md': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-root-padding-top-md': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-root-padding-x-lg': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-root-padding-bottom-lg': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-root-padding-top-lg': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-root-padding-x-xl': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-root-padding-bottom-xl': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-root-padding-top-xl': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-root-padding-x-2xl': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-container-max-width': { category: 'size', unit: 'px', scope: 'theme' },
  '--popular-products-container-width': { category: 'size', scope: 'theme' },
  '--popular-products-container-gap': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-container-gap-md': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-grid-width': { category: 'size', scope: 'theme' },
  '--popular-products-card-gap': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--popular-products-card-width': { category: 'size', scope: 'theme' },
  '--popular-products-card-media-border-radius': { category: 'radius', unit: 'px', scope: 'theme' },
  '--popular-products-card-badge-border-radius': { category: 'radius', unit: 'px', scope: 'theme' },
  '--popular-products-card-badge-font-size': { category: 'size', unit: 'px', scope: 'theme' },
  '--popular-products-card-badge-min-width': { category: 'size', unit: 'px', scope: 'theme' },
  '--popular-products-card-title-width': { category: 'size', scope: 'theme' },
  '--popular-products-card-title-opacity-hover': { category: 'size', scope: 'theme' },
  '--popular-products-card-old-price-color': { category: 'color', scope: 'theme' },
