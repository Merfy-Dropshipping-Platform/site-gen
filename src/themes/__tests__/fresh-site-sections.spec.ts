...
describe('материализация плиток галереи — границы', () => {
  // Кладём галерею на page-about, а НЕ на home: у vanilla главную целиком
  // пересобирает migrateVanillaHomePage (spec 084), и проверка мерила бы её,
  // а не материализацию (поймано первым же прогоном: vanilla был красным).
