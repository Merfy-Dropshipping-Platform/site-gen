...
export const MultiColumnsPuckConfig: BlockPuckConfig<MultiColumnsProps> = {
  ...
  defaults: {
    // Заголовок-заглушка, как у соседних секций (Publications «Публикации»,
    // ContactForm «Связаться с нами»): пустое поле давало секцию, которая
    // начинается сразу с колонок и выглядит оборванной.
