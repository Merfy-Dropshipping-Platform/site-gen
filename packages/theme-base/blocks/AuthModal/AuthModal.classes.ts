export const AuthModalClasses = {
  ...
  heading: 'font-[var(--font-heading)] text-[length:var(--size-hero-heading)] text-[rgb(var(--color-heading))] mb-4',
  loginForm: 'flex flex-col gap-3',
  registerForm: 'flex flex-col gap-3',
  otpForm: 'flex flex-col gap-3',
  field: 'flex flex-col gap-1 font-[var(--font-body)] text-[rgb(var(--color-text))]',
  ...
  submitBtn: 'h-[var(--size-hero-button-h)] rounded-[var(--radius-button)] bg-[rgb(var(--color-button-bg))] text-[rgb(var(--color-button-text))] border border-[rgb(var(--color-button-border))] font-[var(--font-body)]',
  socialLogin: 'mt-3 flex flex-col gap-2',
  error: 'text-[rgb(var(--color-error))] font-[var(--font-body)] text-sm',
