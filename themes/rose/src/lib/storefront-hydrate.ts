...
export function renderCardHtml(p: RealProduct, aspectRatio: string = "318/444"): string {
	...
	const oldPrice = oldRaw
		? `<span class="rose-product-oldprice font-manrope !text-[14px] font-normal !leading-none text-[rgb(var(--color-muted,153_153_153))] line-through">${escapeHtml(oldRaw)}</span>`
		: "";
