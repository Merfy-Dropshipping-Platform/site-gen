...
describe('Bloom Footer override', () => {
  ...
  it('tokens include footer-layout + container-max-width + radius-button (pill)', () => {
  ...
  it('classes expose bloom signature: 1320px container + pill submit + powered-by bar', () => {
