...
export const HeaderClasses = {
  ...
  logoText: 'text-base sm:text-lg md:text-[24px] font-bold tracking-tight leading-none [font-family:var(--font-heading)] text-[rgb(var(--color-heading))]',
  navMenu: 'hidden md:flex items-center gap-[32px]',
  navMenuCentered: 'hidden md:flex items-center justify-center gap-[32px] mt-2',
  navLink: 'text-[length:var(--size-nav-link)] font-medium hover:opacity-70 transition-opacity leading-[1.4] [font-family:var(--font-body)] text-[rgb(var(--color-text))]',
  ...
  cartBadge: 'hidden absolute -top-1 -right-1 text-white text-[11px] font-semibold min-w-[18px] h-[18px] flex items-center justify-center leading-none px-0.5 rounded-[2px] bg-[rgb(var(--color-accent))] [font-family:var(--font-body)]',
  mobileMenu: {
    ...
    link: 'px-4 py-4 text-base font-medium hover:opacity-80 transition-colors border-t border-[rgb(var(--color-text))]/15 [font-family:var(--font-body)] text-[rgb(var(--color-text))]',
    submenuToggle: 'mobile-submenu-toggle w-full px-4 py-4 text-base font-medium hover:opacity-80 transition-colors flex items-center justify-between [font-family:var(--font-body)] text-[rgb(var(--color-text))] border-t border-[rgb(var(--color-text))]/15',
