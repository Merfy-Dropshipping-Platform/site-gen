...
export const HeaderClasses = {
  ...
  logoText: 'text-lg sm:text-xl md:text-2xl font-bold tracking-wide font-[var(--font-body)] text-[rgb(var(--color-heading))]',
  ...
  navLink: 'text-sm md:text-base lg:text-lg xl:text-[20px] font-normal hover:opacity-70 transition-opacity font-[var(--font-body)] text-[length:var(--size-nav-link)] text-[rgb(var(--color-text))]',
  ...
  mobileMenu: {
    ...
    searchInput: 'block w-full h-12 pl-5 pr-12 border border-[rgb(var(--color-text))]/30 rounded-lg text-sm font-normal outline-none font-[var(--font-body)] bg-[rgb(var(--color-bg))] text-[rgb(var(--color-text))] placeholder:text-[rgb(var(--color-muted))]',
