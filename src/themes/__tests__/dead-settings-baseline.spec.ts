 ...
 *
 * Замер 22.09 после починки: 478 полей, мёртвых нет.
 */
...
function прогон(): string[] {
  ...
  // 478 на замере 22.09; порог чуть ниже, чтобы не краснеть от снятия
  // одного поля панели, но ловить обвал разборщика (было 397 из-за скобок).
  expect(отчёт.проверено).toBeGreaterThanOrEqual(450);
