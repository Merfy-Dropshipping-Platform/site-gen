 ...
 */
// Делимитер-ведомый `/`, который НЕ начинает `//` (protocol-relative) и НЕ
// `/*` (CSS-комментарий). Без исключения `*` ре-райтер корраптил `/*` →
...
// `/` валидного ассета всегда ведёт к букве/`_`/цифре, никогда к `*`.
