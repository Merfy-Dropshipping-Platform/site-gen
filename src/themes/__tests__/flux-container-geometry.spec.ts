 ...
 *   3) сама лестница закреплена числами 16 / 80 / 320, иначе пункт 2 остаётся
...
/** Эталонная лестница полей темы (px). Числа — из порта, см. шапку файла. */
...
const EXPECTED_MAX_WIDTH_PX = 1920;
