...
export const FooterClasses = {
  ...
  newsletter: {
    ...
    heading: 'text-2xl sm:text-3xl md:text-[32px] lg:text-[34px] xl:text-[36px] font-normal uppercase leading-[1.115] text-center [font-family:var(--font-heading)] text-[rgb(var(--color-heading))]',
