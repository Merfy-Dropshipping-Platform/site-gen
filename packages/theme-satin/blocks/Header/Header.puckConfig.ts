...
// Satin Header override.
// Keeps the same prop SHAPE as @merfy/theme-base/blocks/Header. Monochrome
// palette + Kelly Slab heading + flat radii come from theme.json tokens.
