export const FooterClasses = {
  ...
  newsletter: {
    ...
    heading: 'font-[var(--font-heading)] font-normal uppercase leading-[1.115] text-[rgb(var(--color-heading))] text-center',
    description: 'font-[var(--font-body)] font-normal leading-[1.366] text-[rgb(var(--color-text))] opacity-70 px-4 sm:px-0 text-center',
    ...
    input: 'flex-1 bg-transparent text-lg sm:text-xl md:text-[22px] lg:text-2xl font-[var(--font-body)] font-light leading-[1.366] outline-none text-[rgb(var(--color-text))] placeholder:text-[rgb(var(--color-muted))]',
  ...
  main: {
    ...
    leftTitle: 'font-[var(--font-heading)] font-normal uppercase leading-[1.115] text-[rgb(var(--color-heading))] text-xl',
    leftNav: 'flex flex-wrap flex-row items-center gap-4 md:gap-6',
    leftLink: 'font-[var(--font-body)] text-[length:var(--size-nav-link)] font-normal leading-[1.366] text-[rgb(var(--color-muted))] hover:text-[rgb(var(--color-text))] transition-colors',
    rightGroup: 'flex flex-wrap items-center gap-6',
    rightEmail: 'font-[var(--font-body)] text-[length:var(--size-nav-link)] font-normal leading-[1.366] text-[rgb(var(--color-muted))] hover:text-[rgb(var(--color-text))] transition-colors',
  ...
  copyright: {
    ...
    text: 'font-[var(--font-body)] font-light leading-[1.21] text-center px-4 sm:px-6',
  },
} as const;
