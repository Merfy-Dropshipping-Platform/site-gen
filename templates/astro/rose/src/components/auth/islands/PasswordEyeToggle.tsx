/**
 * PasswordEyeToggle — React island: кнопка show/hide пароля.
 * Toggles type attribute of the associated input (via data-target-id) between 'password' and 'text'.
 * SSR рендерит initial state = 'hide' (input type=password); после гидратации — интерактивный toggle.
 */
import { useState, useEffect } from 'react';

interface Props {
  targetId: string; // id поля пароля
