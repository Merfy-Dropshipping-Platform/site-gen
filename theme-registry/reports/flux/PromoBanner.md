# PromoBanner @ flux — прогон реестра

Дата: 2026-09-09T09:07:51.068Z · site 132d3a3e-a28f-40b7-98fa-a0200151cfb8 · page home · blockId PromoBanner-home
...
| Ссылка · адрес (`link.href`) | ✓ | href="/__theme/flux/catalog?promo-probe=1" (ждали /catalog?promo-probe=1) | ссылка ведёт по введённому адресу (PromoBanner.astro:13) |
| Размер (`size`) | ✓ | высота 26 → 32 → 40 → 48px | высота полосы растёт: thin 24 / small 32 / medium 40 / large 48 (SIZE_MAP; thin — additive 084) |
