// Rose Catalog — использует базовый puckConfig (Figma «Группа товаров» parity).
// Тема переопределяет только Astro-рендер (Catalog.astro — родная вёрстка rose:
...
// дефолт уже 'top' (родная раскладка rose) — Catalog.astro читает его и ставит
