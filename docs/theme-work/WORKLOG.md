...
### Стенды: rose не покрыт

Стенд `7b64b7a527d2`, помеченный как rose, физически отдаёт **satin**
(`data-nt="satin-header"`, `data-satin-sticky`, `id="satin-burger"`). Живым
замером покрыты satin ×2, vanilla, bloom, flux. По rose — только рендер-пруфы и
гарды. Ровно та ловушка, что записана в
`feedback_tester_single_account_all_themes`.
