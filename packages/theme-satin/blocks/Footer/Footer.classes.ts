...
export const FooterClasses = {
  ...
  newsletter: {
    ...
    heading: 'text-[24px] md:text-[28px] font-normal uppercase tracking-[0.05em] leading-[1.2] mb-[8px] [font-family:var(--font-heading)] text-[rgb(var(--color-heading))]',
  ...
  brand: 'text-[20px] font-normal uppercase tracking-[0.05em] leading-[1.2] [font-family:var(--font-heading)] text-[rgb(var(--color-heading))]',
  navColumn: {
