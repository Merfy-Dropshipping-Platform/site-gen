...
export default {
  ...
  uncovered: {
    ...
    hidden:
      'платформенный тумблер видимости блока (появился в панели 2026-09-08): скрывает секцию целиком на всех темах — не настройка секции, меряется гейтом страниц',
    textTransform:
      'регистр текста полосы. Под computed text-transform у раннера нет типа проверки; проверено вручную на vanilla 2026-09-09: uppercase → класс uppercase в рендере, none → класса нет. Кандидат: добавить тип computed-prop',
  },
};
