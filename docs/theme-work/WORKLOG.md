...
- Существующие магазины: цвета схем хранятся в ревизии (`themeSettings.colorSchemes`) у 186 из 298
  сайтов с темой (bloom 18/18, flux 22/23, rose 98/208, satin 21/21, vanilla 27/28) — новые
  стартовые значения до них не доходят; правило кнопок до них доходит (вид «А»). Миграция не
  делалась — решение за владельцем. PR не сливался.
