...
export const FooterClasses = {
  ...
  newsletter: {
    ...
    heading: 'text-[24px] md:text-[28px] font-semibold leading-[1.2] mb-[8px] font-[var(--font-heading)] text-[rgb(var(--color-heading))]',
    ...
    input: 'flex-1 h-[48px] px-[16px] text-[16px] outline-none font-[var(--font-body)] bg-[rgb(var(--color-bg))] border border-[rgb(var(--color-muted))]/50 text-[rgb(var(--color-text))] placeholder:text-[rgb(var(--color-muted))] rounded-[var(--radius-input)]',
    submit: 'h-[48px] px-[24px] text-[16px] font-medium hover:opacity-90 transition-opacity font-[var(--font-body)] bg-[rgb(var(--color-button-bg))] text-[rgb(var(--color-button-text))] rounded-[var(--radius-button)]',
  },
  main: {
  ...
  brand: 'text-[20px] font-semibold leading-[1.2] font-[var(--font-heading)] text-[rgb(var(--color-heading))]',
  navColumn: {
    root: 'flex flex-col gap-[8px]',
    link: 'text-[16px] font-medium hover:opacity-80 transition-opacity font-[var(--font-body)] text-[rgb(var(--color-text))]',
  },
  infoColumn: {
    wrap: 'flex flex-col gap-[8px] md:items-end',
    label: 'text-[16px] font-normal font-[var(--font-body)] text-[rgb(var(--color-text))]',
    emailLink: 'text-[16px] font-medium hover:opacity-80 transition-opacity font-[var(--font-body)] text-[rgb(var(--color-text))]',
  },
