export const CheckoutLayoutClasses = {
  ...
  summaryHeading: '[font-family:var(--font-heading)] text-[length:var(--size-hero-heading)] text-[rgb(var(--color-heading))] mb-4',
  trustBadges: 'mt-[var(--spacing-section-y)] flex flex-wrap items-center justify-center gap-4 [font-family:var(--font-body)] text-[rgb(var(--color-text))]',
} as const;
