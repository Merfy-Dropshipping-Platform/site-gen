// XSS-safe inline rich-text для заголовков/подзаголовков bloom-портов (паритет rose).
//
...
//
// sanitize-html в bloom-теме НЕТ (не вводим зависимость — Constitution VI). Поэтому
