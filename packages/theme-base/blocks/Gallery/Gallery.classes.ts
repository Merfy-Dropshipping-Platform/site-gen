...
export const GalleryClasses = {
  ...
  heading:
    '[font-family:var(--font-heading)] text-[length:var(--size-section-heading,14px)] leading-[1.15] tracking-[0.1em] uppercase text-[rgb(var(--color-heading))] text-center mb-2',
  subheading:
