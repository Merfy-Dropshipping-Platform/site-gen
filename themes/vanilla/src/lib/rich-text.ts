// XSS-safe inline rich-text для заголовков/подзаголовков vanilla-портов (паритет rose/bloom/satin).
//
...
//
// sanitize-html в vanilla-теме НЕТ (не вводим зависимость — Constitution VI). Поэтому
