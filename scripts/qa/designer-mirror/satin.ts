...
export const satin: Mirror & { known: Known } = {
  known: [
    ...
    },
    {
      section: "rows",
      reason:
        "Любая ширина: решение владельца 17–20.09 (f3ffa73e, ed711995, b68871f1, ebd40ea0, a01dfd7a, ae55ded6, 4287e8ae) главнее вёрстки верстальщика — ряд сплошной, фото и текст впритык (зазор пары 0, у верстальщика md:gap-10=40), у текста свои поля 32px, между рядами 32px. 24.09 (7c87010e) это временно перебивалось геометрией верстальщика — регресс исправлен 25.09.",
    },
  ],
