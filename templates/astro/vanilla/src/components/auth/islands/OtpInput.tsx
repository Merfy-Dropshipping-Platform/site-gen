 ...
 * Emits global event 'otp:complete' when all digits are filled.
 */
...
interface Props {
  length?: number;
  autoFocus?: boolean;
  /** Hidden input name for form submit (value = concatenated digits). */
  name?: string;
  /** Wrapper id for DOM access from parent script. */
  id?: string;
}
