...
export const CheckoutSubmitClasses = {
  root: 'w-full',
  buttonFill: 'w-full h-14 bg-[rgb(var(--color-button-bg))]! text-[rgb(var(--color-button-text))]! rounded-[var(--radius-button)] [font-family:var(--font-body)] text-[length:var(--size-body)] hover:bg-[rgb(var(--color-button-bg-hover))]! hover:text-[rgb(var(--color-button-text-hover))]! transition-colors disabled:opacity-50',
