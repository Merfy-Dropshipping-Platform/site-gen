...
export const FooterClasses = {
  ...
  newsletter: {
    ...
    submit: 'h-[48px] px-[24px] text-[16px] font-normal hover:opacity-90 transition-opacity font-[var(--font-body)] bg-[rgb(var(--color-button-bg))] text-[rgb(var(--color-button-text))]',
  },
  main: {
