								...
								<div class="flex items-baseline gap-2">
									...
									${
										typeof line.oldPrice === "number" && line.oldPrice > line.price
											? `<span class="font-roboto-flex text-[13px] font-light leading-normal text-[rgb(var(--color-muted,153_153_153))] line-through">${formatPrice(line.oldPrice * line.quantity)}</span>`
											: ""
									}
								</div>
							</div>
