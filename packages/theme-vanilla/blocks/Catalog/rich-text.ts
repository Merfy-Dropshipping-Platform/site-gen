...
// vanilla (пакет). Тело ОБЯЗАНО совпадать с themes/*/src/lib/rich-text.ts —
// сторож: src/themes/__tests__/rich-text-bold-italic.spec.ts («все копии
// inlineFormat в репозитории»).
//
// ⚠️ ЗАЧЕМ ОТДЕЛЬНЫЙ ФАЙЛ. Блок «Каталог» живёт в packages/theme-vanilla/blocks,
// а не в themes/vanilla/src, и импортировать ../../lib/rich-text оттуда нельзя:
