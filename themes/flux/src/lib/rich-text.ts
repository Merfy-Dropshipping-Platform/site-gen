// XSS-safe inline rich-text для заголовков/подзаголовков flux-портов (паритет rose/bloom/satin).
//
...
//
// sanitize-html в flux-теме НЕТ (не вводим зависимость — Constitution VI). Поэтому
