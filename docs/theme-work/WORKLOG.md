...
- фон поля — литерал `bg-white` в каждом порту (`themes/rose/src/components/Header.astro:477`,
  vanilla `:566`, bloom `:673`, satin `:295`, flux `:489`);
- текст поля — литерал `text-[#000000]` (rose `:485`, vanilla `:574`, bloom `:681`,
  satin `:296`, flux `:495`);
- кнопка — литерал у bloom (`#e38e9f`, `:685`), satin (`#000000`, `:297`),
  flux (`#1e2952`, `:499`); алиас `--vanilla-header-bg` у vanilla (`:578`);
