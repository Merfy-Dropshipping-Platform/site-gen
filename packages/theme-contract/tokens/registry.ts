...
export const TOKEN_REGISTRY = {
  ...
  '--hero-title-size':         { category: 'size', unit: 'px', scope: 'theme' },
  '--hero-title-size-sm':      { category: 'size', unit: 'px', scope: 'theme' },
  '--hero-title-size-md':      { category: 'size', unit: 'px', scope: 'theme' },
  '--hero-title-size-lg':      { category: 'size', unit: 'px', scope: 'theme' },
  ...
  // ── v2 миграция — токены блока (добавлено скриптом)
  '--gallery-root-padding-x': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-root-padding-x-sm': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-root-padding-x-md': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-root-padding-x-lg': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-root-padding-x-xl': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-root-padding-x-2xl': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-root-padding-bottom': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-root-padding-bottom-sm': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-root-padding-bottom-md': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-root-padding-bottom-lg': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-root-padding-bottom-xl': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-root-padding-top': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-root-padding-top-sm': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-root-padding-top-md': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-root-padding-top-lg': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-root-padding-top-xl': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-container-max-width': { category: 'size', unit: 'px', scope: 'theme' },
  '--gallery-container-gap': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-container-gap-md': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-inner-gap': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-inner-gap-md': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-inner-gap-lg': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-inner-gap-xl': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-item-primary-border-radius': { category: 'radius', unit: 'px', scope: 'theme' },
  '--gallery-item-primary-min-height': { category: 'size', unit: 'px', scope: 'theme' },
  '--gallery-item-small-gap': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-item-small-gap-md': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-card-media-border-radius': { category: 'radius', unit: 'px', scope: 'theme' },
  '--gallery-card-label-font-size': { category: 'size', unit: 'px', scope: 'theme' },
  '--gallery-card-price-font-size': { category: 'size', unit: 'px', scope: 'theme' },
  '--gallery-card-price-color': { category: 'color', scope: 'theme' },
  // ── v2 миграция — токены блока (добавлено скриптом)
  '--header-header-background-color': { category: 'color', scope: 'theme' },
  '--header-header-padding-bottom': { category: 'spacing', unit: 'px', scope: 'theme' },
  ...
  // ── v2 миграция — токены блока (добавлено скриптом)
  '--collections-root-background-color': { category: 'color', scope: 'theme' },
  '--collections-root-padding-y': { category: 'spacing', unit: 'px', scope: 'theme' },
  ...
  // ── v2 миграция — токены блока (добавлено скриптом)
  '--gallery-heading-font-size': { category: 'size', unit: 'px', scope: 'theme' },
  '--gallery-cta-button-margin-top': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-cta-button-height': { category: 'size', unit: 'px', scope: 'theme' },
  '--gallery-cta-button-min-height': { category: 'size', unit: 'px', scope: 'theme' },
  '--gallery-cta-button-border-color': { category: 'color', scope: 'theme' },
  '--gallery-cta-button-padding-x': { category: 'spacing', unit: 'px', scope: 'theme' },
  '--gallery-cta-button-font-size': { category: 'size', unit: 'px', scope: 'theme' },
  '--gallery-cta-button-color': { category: 'color', scope: 'theme' },
  '--gallery-cta-button-opacity-hover': { category: 'size', scope: 'theme' },
