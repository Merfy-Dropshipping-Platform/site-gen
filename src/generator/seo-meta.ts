/**
 * SEO мета-патчинг PDP-шелла — ЧИСТЫЕ функции (без NestJS/fs/RPC), извлечены из
 * build.service чтобы быть unit-тестируемыми в изоляции. build.service форвардит
 * сюда per-product патч (замыкание patchPdpMeta), передавая захваченные
