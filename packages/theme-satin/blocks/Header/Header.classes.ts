...
export const HeaderClasses = {
  ...
  logoText: 'text-base sm:text-lg md:text-[26px] font-normal uppercase tracking-[0.05em] leading-none font-[var(--font-heading)] text-[rgb(var(--color-heading))]',
  ...
  navLink: 'text-[length:var(--size-nav-link)] font-normal uppercase tracking-[0.05em] hover:opacity-70 transition-opacity leading-[1.4] font-[var(--font-body)] text-[rgb(var(--color-text))]',
  ...
  mobileMenu: {
    ...
    link: 'px-4 py-4 text-base font-normal uppercase tracking-[0.05em] hover:opacity-80 transition-colors border-t border-[rgb(var(--color-text))]/15 font-[var(--font-body)] text-[rgb(var(--color-text))]',
    submenuToggle: 'mobile-submenu-toggle w-full px-4 py-4 text-base font-normal uppercase tracking-[0.05em] hover:opacity-80 transition-colors flex items-center justify-between font-[var(--font-body)] text-[rgb(var(--color-text))] border-t border-[rgb(var(--color-text))]/15',
