...
export const FooterClasses = {
  ...
  newsletter: {
    ...
    heading: 'text-[24px] md:text-[28px] font-normal leading-[1.2] mb-[8px] font-[var(--font-heading)] text-[rgb(var(--color-heading))]',
    ...
    submit: 'h-[48px] px-[24px] text-[16px] font-normal hover:opacity-90 transition-opacity font-[var(--font-body)] bg-[rgb(var(--color-button-bg))] text-[rgb(var(--color-button-text))] rounded-[var(--radius-button)]',
  },
  main: {
  ...
  brand: 'text-[20px] font-normal leading-[1.2] font-[var(--font-heading)] text-[rgb(var(--color-heading))]',
  navColumn: {
