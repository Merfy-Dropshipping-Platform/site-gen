...
- Высота документа: reference=5620 → local-live=4712 (Δ -908)
- Секций: reference=8 → local-live=8

| секция | y (эталон→локал) | h (эталон→локал) | Δh | вердикт |
|---|---|---|---:|---|
| Header | 48→48 (Δ0) | 80→80 | 0 | ✓ совпадает |
| hero-title | 128→128 (Δ0) | 380→380 | 0 | ✓ совпадает |
| collections | 508→508 (Δ0) | 1322→564 | -758 | ✗ расходится |
| featured | 1830→1072 (Δ-758) | 888→812 | -76 | ✗ расходится |
| popular | 2718→1883 (Δ-834) | 904→688 | -216 | ✗ расходится |
| cta-title | 3621→2571 (Δ-1050) | 361→728 | 367 | ⚠️ РАЗНЫЕ: cta-title vs ImageWithText-home-title |
| gallery | 3982→3299 (Δ-683) | 737→662 | -75 | ⚠️ РАЗНЫЕ: gallery vs main-child-5 |
| Footer | 4719→3960 (Δ-758) | 901→752 | -149 | ✗ расходится |

### viewport 768

- Высота документа: reference=5527 → local-live=5538 (Δ 11)
- Секций: reference=8 → local-live=8

| секция | y (эталон→локал) | h (эталон→локал) | Δh | вердикт |
|---|---|---|---:|---|
| Header | 48→48 (Δ0) | 136→136 | 0 | ✓ совпадает |
| hero-title | 184→184 (Δ0) | 480→480 | 0 | ✓ совпадает |
| collections | 664→664 (Δ0) | 486→431 | -55 | ✗ расходится |
| featured | 1150→1095 (Δ-55) | 1506→1286 | -220 | ✗ расходится |
| popular | 2656→2381 (Δ-275) | 611→483 | -128 | ✗ расходится |
| cta-title | 3267→2864 (Δ-403) | 315→979 | 664 | ⚠️ РАЗНЫЕ: cta-title vs ImageWithText-home-title |
| gallery | 3581→3842 (Δ261) | 1308→1110 | -198 | ⚠️ РАЗНЫЕ: gallery vs main-child-5 |
| Footer | 4889→4952 (Δ63) | 638→586 | -52 | ✗ расходится |

### viewport 1280

- Высота документа: reference=4726 → local-live=4665 (Δ -61)
- Секций: reference=8 → local-live=8

| секция | y (эталон→локал) | h (эталон→локал) | Δh | вердикт |
|---|---|---|---:|---|
| Header | 48→48 (Δ0) | 136→136 | 0 | ✓ совпадает |
| hero-title | 184→184 (Δ0) | 540→540 | 0 | ✓ совпадает |
| collections | 724→724 (Δ0) | 602→602 | 0 | ✓ совпадает |
| featured | 1326→1326 (Δ0) | 814→678 | -136 | ✗ расходится |
| popular | 2140→2004 (Δ-136) | 719→611 | -108 | ✗ расходится |
| cta-title | 2858→2614 (Δ-244) | 315→668 | 354 | ⚠️ РАЗНЫЕ: cta-title vs ImageWithText-home-title |
| gallery | 3173→3282 (Δ110) | 915→797 | -118 | ⚠️ РАЗНЫЕ: gallery vs main-child-5 |
| Footer | 4088→4079 (Δ-8) | 638→586 | -52 | ✗ расходится |

### viewport 1920

- Высота документа: reference=5297 → local-live=5296 (Δ -1)
- Секций: reference=8 → local-live=8

| секция | y (эталон→локал) | h (эталон→локал) | Δh | вердикт |
|---|---|---|---:|---|
| Header | 48→48 (Δ0) | 136→136 | 0 | ✓ совпадает |
| hero-title | 184→184 (Δ0) | 810→810 | 0 | ✓ совпадает |
| collections | 994→994 (Δ0) | 668→655 | -13 | ✗ расходится |
| featured | 1662→1649 (Δ-13) | 916→780 | -136 | ✗ расходится |
| popular | 2578→2429 (Δ-149) | 769→651 | -118 | ✗ расходится |
| cta-title | 3347→3080 (Δ-267) | 291→748 | 458 | ⚠️ РАЗНЫЕ: cta-title vs ImageWithText-home-title |
| gallery | 3637→3828 (Δ190) | 1022→883 | -139 | ⚠️ РАЗНЫЕ: gallery vs main-child-5 |
| Footer | 4659→4710 (Δ51) | 638→586 | -52 | ✗ расходится |
